...
#sudo ./configure*.sh --config /opt/poky/qt5/environment-setup-i586-poky-linux --qtcreator $HOME/QtFree/Tools/QtCreator
#$HOME/QtFree/Tools/QtCreator/bin/qtcreator
set -e
