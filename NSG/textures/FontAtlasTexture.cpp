...
namespace NSG
{
    FontAtlasTexture::FontAtlasTexture(const Path& path, int viewWidth, int viewHeight)
        : path_(path),
    ...
    void FontAtlasTexture::SetViewSize(int width, int height)
    {
    ...
    void FontAtlasTexture::GenerateMesh(const std::string& text, VertexsData& vertexsData, Indexes& indexes, GLfloat& screenWidth, GLfloat& screenHeight)
    {
        vertexsData.clear();
        indexes.clear();
