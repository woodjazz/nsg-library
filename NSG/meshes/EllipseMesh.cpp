...
namespace NSG {
EllipseMesh::EllipseMesh(const std::string& name) : ProceduralMesh(name) {
    Set();
...
GLenum EllipseMesh::GetWireFrameDrawMode() const { return GL_LINE_LOOP; }

GLenum EllipseMesh::GetSolidDrawMode() const { return GL_TRIANGLE_FAN; }
