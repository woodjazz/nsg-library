...
class Mesh : public std::enable_shared_from_this<Mesh>,
             public Object,
             public WeakFactory<std::string, Mesh> {
public:
    virtual ~Mesh();
    ...
    IndexBuffer* GetIndexBuffer(bool solid) const {
        return solid ? pIBuffer_.get() : pIWireBuffer_.get();
    }
    ...
    const Indexes& GetIndexes(bool solid) const {
        return solid ? indexes_ : indexesWireframe_;
    }
    ...
    const std::set<SceneNode*>& GetConstSceneNodes() const {
        return sceneNodes_;
    }
    void AddQuad(const VertexData& v0, const VertexData& v1,
                 const VertexData& v2, const VertexData& v3,
                 bool calcFaceNormal);
    void AddTriangle(const VertexData& v0, const VertexData& v1,
    ...
    const VertexData& GetTriangleVertex(size_t triangleIdx,
    ...
    virtual PhysicsShape GetShapeType() const {
        return SH_CONVEX_TRIMESH;
    } // assume rigidbody is dynamic by default
