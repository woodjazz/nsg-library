...
namespace NSG
{
	GLES2FilterBlend::GLES2FilterBlend(PGLES2Texture input0, PGLES2Texture input1, PGLES2Texture output)
	: GLES2Filter(input0, output, fShader),
	blendMode_loc_(-1),
	blendMode_(0)
	{
	...
	void GLES2FilterBlend::SetLocations()
	{
	...
	void GLES2FilterBlend::AssignValues()
	{
		if(blendMode_loc_ != -1)
		{
