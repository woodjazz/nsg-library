...
public:
    ...
    std::shared_ptr<btDiscreteDynamicsWorld> GetWorld() const {
    ...
    ///////////////////////////////////////////////////////////////////////////////////////
    // Bullet btIDebugDraw
    // bool isVisible(const btVector3& aabbMin, const btVector3& aabbMax)
    // override;
    ...
    SphereCast(const Vector3& origin, const Vector3& direction, float radius,
               float maxDistance, int collisionMask = (int)CollisionMask::ALL);
    PhysicsRaycastResult
    SphereCastBut(const ICollision* collider, const Vector3& origin,
                  const Vector3& direction, float radius, float maxDistance,
                  int collisionMask = (int)CollisionMask::ALL);
    PhysicsRaycastResult RayCast(const Vector3& origin,
