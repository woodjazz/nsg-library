...
public:
    ...
    void SetStencilTest(bool enable, GLuint writeMask, GLenum sfail,
                        GLenum dpfail, GLenum dppass, GLenum func, GLint ref,
                        GLuint compareMask);
    void SetScissorTest(bool enable = false, GLint x = 0, GLint y = 0,
    ...
    bool SetupProgram(const Pass* pass, const Scene* scene,
