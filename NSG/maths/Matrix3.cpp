...
Matrix3::Matrix3(float x1, float y1, float z1, float x2, float y2, float z2,
...
Matrix3 Matrix3::Inverse() const {
    ...
    Matrix4 inverse;
    inverse[0][0] = +(value[1][1] * value[2][2] - value[2][1] * value[1][2]) *
                    OneOverDeterminant;
    inverse[1][0] = -(value[1][0] * value[2][2] - value[2][0] * value[1][2]) *
                    OneOverDeterminant;
    inverse[2][0] = +(value[1][0] * value[2][1] - value[2][0] * value[1][1]) *
                    OneOverDeterminant;
    inverse[0][1] = -(value[0][1] * value[2][2] - value[2][1] * value[0][2]) *
                    OneOverDeterminant;
    inverse[1][1] = +(value[0][0] * value[2][2] - value[2][0] * value[0][2]) *
                    OneOverDeterminant;
    inverse[2][1] = -(value[0][0] * value[2][1] - value[2][0] * value[0][1]) *
                    OneOverDeterminant;
    inverse[0][2] = +(value[0][1] * value[1][2] - value[1][1] * value[0][2]) *
                    OneOverDeterminant;
    inverse[1][2] = -(value[0][0] * value[1][2] - value[1][0] * value[0][2]) *
                    OneOverDeterminant;
    inverse[2][2] = +(value[0][0] * value[1][1] - value[1][0] * value[0][1]) *
                    OneOverDeterminant;
    return inverse;
}
...
const Vector3& Matrix3::Column(int index) const { return value[index]; }
}
