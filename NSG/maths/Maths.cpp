...
bool IsPowerOfTwo(int value) { return (!(value & (value - 1)) && value); }
...
float Radians(float degrees) { return degrees * DEG2RAD; }

float Degrees(float radians) { return radians * RAD2DEG; }

float Distance(float a, float b) { return std::abs(b - a); }
