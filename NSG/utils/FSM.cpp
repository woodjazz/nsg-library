...
State::State() : nextBeginState_(nullptr) {}
...
void State::InternalBegin() { Begin(); }

void State::InternalEnd() { End(); }

Machine::Machine() : pInitialState_(nullptr), pCurrentState_(nullptr) {}
...
void Machine::Go() {
    slotUpdate_ =
        Engine::SigUpdate()->Connect([this](float deltaTime) { Update(); });
}
}
}