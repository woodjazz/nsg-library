...
Color::Color(float v) : r(v), g(v), b(v), a(1.f) {}

Color::Color(float r, float g, float b, float a) : x(r), y(g), z(b), w(a) {}

Color::Color(const Vector3& v) : x(v.x), y(v.y), z(v.z), w(1) {}

Color::Color(const Vector4& v) : x(v.x), y(v.y), z(v.z), w(v.w) {}

Color::Color(const Color& v) : x(v.x), y(v.y), z(v.z), w(v.w) {}
