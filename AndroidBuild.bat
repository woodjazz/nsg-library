...
cmake %SOURCE_FOLDER% -G "Unix Makefiles" -DCMAKE_MAKE_PROGRAM="%ANDROID_NDK%/prebuilt/windows/bin/make.exe" -DCMAKE_TOOLCHAIN_FILE="%SOURCE_FOLDER%/android.toolchain.cmake" -DANDROID_NATIVE_API_LEVEL=android-9 -DLIBRARY_OUTPUT_PATH_ROOT=./test/AndroidHost
