...
int main(int argc, char** argv) {
    ...
    try {
        ...
        CmdLine cmd("Command description message. This is a long multi-line "
                    "message meant to test line wrapping.  This is more text "
                    "that doesn't really do anything besides take up lots of "
                    "space that otherwise might be used for something real.  "
        ...
        MultiArg<string> nameArg(
            "n", "name", "Name to print. This is a long, nonsensical message "
                         "to test line wrapping.  Hopefully it works.",
            true, &vallowed);
        cmd.add(nameArg);
        ...
        argv[0] = const_cast<char*>("ThisIsAVeryLongProgramNameDesignedToTestSp"
                                    "acePrintWhichUsedToHaveProblemsWithLongPro"
                                    "gramNamesIThinkItIsNowLongEnough");
