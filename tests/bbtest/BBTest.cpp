...
static void Test01() {
...

    {
        ...
        CHECK_CONDITION(bb.IsInside(BoundingBox(v2, v1)) ==
                        Intersection::INTERSECTS);
        CHECK_CONDITION(bb.IsInside(BoundingBox(Vertex3(-5), Vertex3(5))) ==
                        Intersection::INTERSECTS);
        CHECK_CONDITION(bb.IsInside(BoundingBox(Vertex3(-6), Vertex3(-5))) ==
