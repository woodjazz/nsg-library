...
#cmake $SOURCE_FOLDER -G "Unix Makefiles" -DANDROID_STL=gnustl_shared -DBUILD_PROJECT="all" -DANDROID_TOOLCHAIN_NAME="arm-linux-androideabi-clang3.6" -DCMAKE_BUILD_TYPE="Debug" -DCMAKE_TOOLCHAIN_FILE="$SOURCE_FOLDER/CMake/Toolchains/android.toolchain.cmake" -DANDROID_NATIVE_API_LEVEL=android-19 -DLIBRARY_OUTPUT_PATH_ROOT=$PWD
cmake $SOURCE_FOLDER -G "Unix Makefiles" -DANDROID_STL=gnustl_shared -DBUILD_PROJECT="all" -DANDROID_TOOLCHAIN_NAME="arm-linux-androideabi-clang3.6" -DCMAKE_BUILD_TYPE="Release" -DCMAKE_TOOLCHAIN_FILE="$SOURCE_FOLDER/cmake/toolchains/android.toolchain.cmake" -DANDROID_NATIVE_API_LEVEL=android-19 -DLIBRARY_OUTPUT_PATH_ROOT=$PWD
