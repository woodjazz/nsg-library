...
int NSG_MAIN(int argc, char* argv[]) {
...

    {
        ...
        auto resourceColor =
            Resource::GetOrCreate<ResourceFile>("data/wall_COLOR.png");
        auto textureColor = std::make_shared<Texture2D>(
            resourceColor,
            (int)TextureFlag::GENERATE_MIPMAPS | (int)TextureFlag::INVERT_Y);
        auto resourceNormal =
            Resource::GetOrCreate<ResourceFile>("data/wall_NRM.png");
        auto textureNormal = std::make_shared<Texture2D>(
            resourceNormal,
            (int)TextureFlag::GENERATE_MIPMAPS | (int)TextureFlag::INVERT_Y);
