...
**/   
  function domContentLoaded(id, src, width, height, attrs) 
  {
    ...
    updateStatus('Page loaded.');
      ...
      navigator.webkitPersistentStorage.requestQuota(1024 * 1024,
          function(bytes) {
            ...
            common.naclModule = createNaClModule(id, src, width, height, attrs);
          },
   ...
   * named "listener".
   */
  function createNaClModule(id, src, width, height, attrs) {
...
document.addEventListener('DOMContentLoaded', function() {
	common.domContentLoaded("nsg_pnacl", "nsg.nmf", 320, 200);
});
