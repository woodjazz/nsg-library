...
macro (setup_common)
    ...
    elseif(UNIX AND NOT APPLE)
        ...
        if("${EGL_LIBRARY}" MATCHES "NOTFOUND")
    ...
    elseif(EMSCRIPTEN)
        ...
        if(IS_TARGET_LINUX)
            find_package(X11 REQUIRED)
                find_package(EGL QUIET)
                if(NOT "${EGL_LIBRARY}" MATCHES "NOTFOUND")
                    set(LIBRARIES_2_LINK ${LIBRARIES_2_LINK} ${EGL_LIBRARY} )
                endif()
...
macro (setup_install)
    install (TARGETS ${PROJECT_NAME} RUNTIME DESTINATION nsg/${PROJECT_NAME})
    if(EXISTS "${data_dir}")
        install(DIRECTORY ${data_dir} DESTINATION nsg/${PROJECT_NAME})
    endif()
endmacro()
